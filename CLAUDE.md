...
| **이슈리포트** | 6 | .md 파일 생성 | 배경·목적 / 연구방법 / 주요결과 | O |
| **카드뉴스** | 7 | 링크만 (`link_only: true`) | .md 파일 없음 | - |
| **브리프** | 8 | 링크만 (`link_only: true`) | .md 파일 없음 | - |
| **국제소식** | 9,10,11,12 | .md 파일 생성 | 웹 기사 내용 요약만 | - |
...
### 연구보고서 (order 1,2,3,4,5) 및 이슈리포트 (order 6) - 구조화된 요약
