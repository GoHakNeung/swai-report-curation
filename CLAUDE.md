...
### 국제소식 (order 9~12) - 간단한 본문

**자료 수집 절차** (매우 중요):
1. 교육정책네트워크 국제기구 동향 사이트에서 기사 **제목만 확인하지 말 것**
2. 각 기사의 **외부 링크 따라가기** (OECD, UNESCO, World Bank 등)
3. 원본 사이트에서 **실제 자료 읽고 분석하기**
4. 원본 자료를 기반으로 **정확한 요약 작성**
5. 구체적인 통계, 발견사항, 정책 권고사항 등 포함

**주의**: 제목만으로는 대략적인 요약을 만들어서는 안 되며, 반드시 원본 자료의 실제 내용을 확인한 후에 작성해야 함.

마크다운 파일의 본문은 **다음 구조**로 작성:

```markdown
## 요약
(원본 자료를 기반으로 한 해당 기관이 게재한 웹 기사/소식의 핵심 내용)
```
