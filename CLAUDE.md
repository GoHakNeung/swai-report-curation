...
|------|-------------|---------|---------|------|
| **연구보고서** | 1,4,8,9,11,12 | .md 파일 생성 | 배경·목적 / 연구방법 / 주요결과 | O |
| **브리프** | 5 | .md 파일 생성 | 배경·목적 / 연구방법 / 주요결과 | - |
| **국제소식** | 2,6,7,10 | .md 파일 생성 | 웹 기사 내용 요약만 | - |
| **카드뉴스** | 3 | 링크만 (`link_only: true`) | .md 파일 없음 | - |
...
### 연구보고서 (order 1,4,8,9,11,12) 및 브리프 (order 5) - 구조화된 요약
